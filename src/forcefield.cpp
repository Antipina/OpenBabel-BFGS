...
namespace OpenBabel
{
  ...
  **/
  ...
  void OBForceField::BFGSInitialize(int steps, double econv, int method)
  {
    ...
    // TODO Can any of these be removed/combined? This will eat a lot of
    // memory for large molecules, and may exceed the capacity of legacy
    // systems.
